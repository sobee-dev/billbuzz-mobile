...
// ─── Filter config — staff view only ever deals in sales & proforma docs ─────
// Supplier orders (purchase_invoice) are intentionally excluded from this screen.

type TypeFilter = 'all' | Extract<DocumentType, 'sales_invoice' | 'proforma_invoice'>;

const STAFF_DOCUMENT_TYPES: DocumentType[] = ['sales_invoice', 'proforma_invoice'];
...
function DocCard({ doc, currency, currentUser, onPress }: {
  doc:         Document;
  currency:    string;
